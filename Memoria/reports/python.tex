...
\begin{itemize}
	\item \texttt{crearNodoA}: Crea un diccionario con la clave \texttt{key} a \texttt{None} y las claves \texttt{left} y \texttt{right} como diccionarios vacíos. Debido a lo comentado arriba, esta función no se puede hacer pública.
	\item \texttt{arbolVacio}: Devuelve un diccionario vacío.
	\item \texttt{insertar\_r}
	\item \texttt{insertar\_i}
	\item \texttt{buscar\_r}
	\item \texttt{buscar\_i}
	\item \texttt{sup2}
	\item \texttt{eliminar\_r}
	\item \texttt{eliminar\_i}
\end{itemize}
